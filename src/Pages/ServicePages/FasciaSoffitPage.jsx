...
const FasciaSoffitPage = ({ setCurrentPage }) => {
  ...
  return (
    <div className="bg-white w-full overflow-x-hidden text-[#243453]">
      ...
      {/* 1. HERO SECTION (Synchronized with SlateTilePage Layout) */}
        ...
        <div className="max-w-screen-2xl w-full mx-auto px-4 md:px-10 relative z-10 text-center">
          ...
          <div className="py-12 flex flex-col justify-center items-center">
            ...
            <p className="text-lg md:text-xl 2xl:text-2xl text-slate-100 leading-relaxed mb-8 font-medium max-w-2xl mx-auto">
              Protect your roofline and improve your home’s appearance with professionally installed fascias, soffits, and guttering in Brighton & Hove.
            </p>
        ...
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-3/5 text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl 2xl:text-5xl font-black uppercase mb-8 leading-tight text-[#243453]">
                A Properly Installed <br />
              ...
              <div className="space-y-6 text-slate-600 text-lg font-medium leading-relaxed">
                ...
                <p className="border-l-4 max-lg:border-l-0 max-lg:border-t-4 max-lg:pt-4 border-[#F9D759] pl-6 max-lg:pl-0 italic text-[#243453] font-bold">
            ...
            <div className="lg:w-2/5 w-full self-stretch min-h-[350px] lg:min-h-0 relative">
              <div className="relative h-full min-h-[350px] shadow-2xl w-full rounded-[2.5rem] overflow-hidden shadow-xl border border-slate-100 bg-slate-900">
                <img
                  src="/images/black-guttering-fascia.jpg"
                  alt="black guttering fascia & soffits"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-8 bg-white/5 border border-white/10 rounded-2xl text-left"
                >
                  <item.icon
                    className="text-[#F9D759] mb-4 animate-none"
                    size={32}
                  />
                  <h4 className="text-lg font-black uppercase mb-2 tracking-wide text-white">
                    {item.title}
                  </h4>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              icon: Construction,
            ...
            <div
              key={i}
              className="p-10 bg-slate-50 rounded-[2rem] border-b-8 border-[#F9D759] text-left"
            >
              <item.icon
      ...
      <section className="py-16 bg-slate-50 border-t border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10">
          <div className="bg-[#243453] rounded-[3rem] overflow-hidden flex flex-col lg:flex-row shadow-2xl border-b-8 border-[#F9D759] items-stretch">
            <div className="lg:w-3/5 py-12 px-8 md:p-12 text-white text-left space-y-8">
              <h2 className="text-3xl lg:text-4xl max-lg:text-center font-black uppercase leading-tight">
                Doing the Job <br />
                <span className="text-[#F9D759]">Properly</span>
              </h2>
              <p className="text-slate-300 max-lg:text-center text-lg font-medium leading-relaxed">
                Most "cheap" quotes involve pinning new plastic over old, rotting wood (capping). We refuse to do that. It traps moisture and accelerates rot.
              </p>
              <div className="space-y-6">
                {[
                  ...
                  >
                    <item.icon
                      className="text-[#F9D759] shrink-0 mt-0.5"
                      size={24}
                    />
                    <div>
                      <h4 className="font-black uppercase mb-1 tracking-wide text-white">
                        {item.title}
                      </h4>
                      <p className="text-slate-400 text-sm font-semibold leading-relaxed">
                        {item.text}
            ...
            <div className="lg:w-2/5 w-full self-stretch min-h-[400px] bg-[url('/images/fascia-soffit-replacement.jpg')] bg-cover bg-center" />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 text-left">
              ...
              <div className="space-y-6 text-slate-600 text-lg font-medium leading-relaxed mb-10">
                <p>
                  We install modern uPVC roofline systems designed to be durable, weather-resistant, and low maintenance.
                </p>
                <p>
                  Unlike traditional timber, these materials do not require regular painting and are less prone to rot or deterioration. When fitted correctly, they provide long-lasting protection while maintaining a clean and consistent appearance.
                </p>
              </div>
            ...
            <div className="lg:w-1/2 w-full max-w-xl lg:max-w-none">
              <div className="relative p-3 bg-[#243453] rounded-[2rem] shadow-xl">
                <img
                  ...
                  alt="uPVC Roofline Configuration"
