    ...
    <div className="bg-white mt-[-30px] w-full sm:mt-[-40px] lg:mt-[-30px] xl:mt-[-20px] overflow-x-hidden text-[#243453]">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-200 text-lg 2xl:text-xl mb-8 leading-relaxed">
                Your fascias and gutters are your home's first line of defense
                against Brighton’s coastal weather. Leaving timber to rot can
                lead to structural damage and damp lofts.
              </p>
              <div className="inline-flex items-center gap-4 p-4 bg-white/5 rounded-xl border border-white/10 italic text-slate-300 text-base">
                ...
                Dripping gutters are often a sign of failed seals or incorrect
                "fall."
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                {
                  title: "Rotting Timber",
                  desc: "Soft spots or peeling paint on old wooden boards.",
                  icon: Hammer,
                },
                {
                  title: "Gutter Overspill",
                  desc: "Water marks on brickwork or internal damp patches.",
                  icon: Droplets,
                },
                {
                  title: "Pest Entry",
                  desc: "Gaps in soffits that allow birds or rodents into your loft.",
                  icon: Bird,
                },
                {
                  title: "Sagging Lines",
                  desc: "Gutters that have lost their fall and hold standing water.",
                  icon: Construction,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-8 bg-white/5 border border-white/10 rounded-2xl group"
                >
                  <item.icon className="text-[#F9D759] mb-4" size={32} />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10 text-center mb-16">
          <h2 className="text-3xl lg:text-4xl 2xl:text-5xl font-black uppercase text-[#243453] mb-4">
            Complete{" "}
            <span className="text-[#F9D759]">Roofline Replacement</span>
          </h2>
          <p className="max-w-2xl mx-auto text-slate-600 text-lg font-medium">
            We don't just "cover up" old rot. We provide a full-system refresh
            using premium, low-maintenance uPVC designed for the South Coast.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "Thick-core uPVC boards that never need painting and won't rot, flake, or crack.",
            },
            {
              icon: Droplets,
              title: "High-Flow Guttering",
              text: "Deep-flow systems designed to handle heavy coastal rainfall without overflowing.",
            },
            {
              icon: Wind,
              title: "Hidden Ventilation",
              text: "Discrete airflow strips that prevent loft condensation and timber decay.",
            },
          ].map((item, i) => (
            <div
              key={i}
        ...
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10">
          <div className="bg-[#243453] rounded-[3rem] overflow-hidden flex flex-col lg:flex-row shadow-2xl border-b-8 border-[#F9D759]">
            <div className="lg:w-1/2 p-12 text-white">
              <h2 className="text-3xl lg:text-4xl 2xl:text-5xl font-black uppercase mb-8 leading-tight">
                Doing the Job <br />
      ...
      {/* 5. MATERIALS & FINISH - Compact Version */}
      <section className="py-16 bg-white">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            {/* Left Column: Text & Swatches */}
            <div className="lg:w-1/2">
              <h2 className="text-3xl lg:text-4xl font-black uppercase mb-4 text-[#243453]">
                Styles to Suit <br />
                <span className="text-[#F9D759]">Your Home</span>
              </h2>
              <p className="text-slate-600 text-base mb-6 font-medium leading-relaxed">
                Our high-quality uPVC systems are available in a variety of
                finishes to perfectly match your existing windows and doors.
              </p>
                ...
                {[
                  {
                    ...
                    title: "Classic White",
                    desc: "Clean, bright, and cost-effective.",
                  },
                  {
                    color: "bg-[#35393C]",
                    title: "Anthracite Grey",
                    desc: "The modern choice for contemporary homes.",
                  },
                  {
                    color: "bg-[#1A1A1A]",
                    title: "Black Ash",
                    desc: "A high-contrast, premium woodgrain finish.",
                  },
                ].map((style, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-3 rounded-xl bg-slate-50 border-l-4 border-[#243453]"
                  >
                    <div
                      className={`${style.color} w-12 h-12 rounded-lg shrink-0 shadow-sm`}
                    />
                    <div>
                      <h4 className="font-black uppercase text-[#243453] text-sm leading-tight">
                        {style.title}
                      </h4>
