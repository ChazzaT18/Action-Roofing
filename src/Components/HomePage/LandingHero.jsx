...
const LandingHero = () => {
  const scrollToSection = (sectionId) => {
    ...
    if (element) {
      // 1. Calculate where the element is relative to the page
      const elementPosition =
        element.getBoundingClientRect().top + window.pageYOffset;

      // 2. Subtract your offset (Header height + some padding)
          ...
          <div className="grid grid-cols-1 xl: lg:grid-cols-12 max-sm:mt-[30px] gap-8 items-center">
            ...
            <div className="lg:col-span-8 lg:col-start-3 max-sm:my-10 text-white flex flex-col justify-center gap-6 items-center text-center">
              <div className="space-y-4">
                <p className="text-[#F9D759] font-bold tracking-widest uppercase 2xl:text-lg text-xs sm:text-base">
              ...
              <div className="flex flex-col items-center pt-2">
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <Link
                    to="contact-us"
                    className="px-8 py-4 bg-[#F9D759] hover:bg-[#F7CB28] text-[#243453] font-bold rounded-lg shadow-xl transition-all flex items-center justify-center gap-2 group transform hover:scale-105"
                  >
                    Get a Free Quote
                    <ArrowRight
                      size={16}
            ...
            <div className="hidden lg:flex lg:col-span-2 justify-end items-center">
              <div
                ...
                className="bg-white cursor-pointer p-6 rounded-2xl shadow-2xl flex flex-col items-center text-center space-y-2 border-t-4 border-[#F9D759] transform rotate-3 hover:rotate-0 transition-transform duration-500 cursor-default"
              >
                <ShieldCheck size={48} className="text-[#243453]" />
                <span className="text-2xl 2xl:text-2xl font-black text-[#243453]">
                  10-YEAR
                </span>
                <span className="text-sm 2xl:text-lg font-bold uppercase tracking-wider text-slate-600 leading-tight">
                  Workmanship <br /> Guarantee
                </span>
                <div className="h-[1px] w-12 bg-slate-200 my-1" />
                <span className="text-[10px] 2xl:text-sm font-bold text-[#F48120] uppercase">
